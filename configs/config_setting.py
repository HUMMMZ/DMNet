...
class setting_config:
    ...
    loss_name = 'SmooothL1_BceDiceLoss'
    ...
    elif network == 'UltraLight_VM_UNet' or network == 'VM_UNet':
        model_config = {
            'num_classes': 1,
            'input_channels': 3,
    ...
    if datasets == 'ISIC2017':
        ...
        data_path = 'dataprepare/tn3kdataset/'
    elif datasets == 'TNUI':
        data_path = 'dataprepare/TNUI/'
    else:
    ...
    rank = None
    amp = False
    if network in ['VMUNet', 'trfe', 'RNNet'] :
        batch_size = 32
    elif network in ['unet', 'UltraLight_VM_UNet', 'fcn', 'HNet']:
        batch_size = 64
    elif network in ['HNet1', 'HNet2', 'HNetskip']:
        batch_size = 16
    epochs = 100
    ...
    if loss_name == 'BceDiceLoss':
        ...
        work_dir = 'results/' + datasets + '/' + network + '/'
    else :
        criterion = SmooothL1_BceDiceLoss()
        work_dir = 'results/' + datasets + '/' + network + '/SmooothL1_BceDiceLoss/'
